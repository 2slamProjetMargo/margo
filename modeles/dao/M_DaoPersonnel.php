...
/**
 * Description of M_DaoPersonnel
 *
 * @author btssio
 */
class M_DaoPersonnel {
    ...
    public function enregistrementVersObjet($enreg) {
        ...
        $retour = new M_Personne(
                $enreg['IDPERSONNE'], $enreg['NOM'], $enreg['PRENOM'], $enreg['SITUATION'], $enreg['ADRESSE']
                );
        return $retour;
    }
    ...
    function getAll() {
        $retour = null;
        // Requête textuelle
        $sql = "SELECT IDPERSONNE, NOM, PRENOM, SITUATION, ADRESSE FROM ETUDIANT e INNER JOIN PERSONNE p ";
